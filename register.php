    ...
    <div class="wrapper">
        ...
        <form action="reg.php" method="post" id="myForm">
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" name="username" class="form-control <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
                <span class="invalid-feedback"><?php echo $username_err; ?></span>
            </div>    
            <div class="form-group">
                <label><b>Password</b></label>
                <input autocomplete="off" type="password" name="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $password; ?>">
            ...
            <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="phone" name="phone" placeholder="enter ur phone number" type="text" required="required" class="form-control" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="off" id="age" name="age" placeholder="age" type="text" class="form-control" required="required">
                    </div>
                    <div class="form-group">
                        <label for="address">Address</label>
                        <input autocomplete="off" id="address" name="address" placeholder="enter ur address" type="text" class="form-control" required="required">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input autocomplete="off" id="email" name="email" placeholder="enter ur email" type="email" class="form-control" required="required">
                    </div>
