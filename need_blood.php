...
<div class="col-lg-4 mb-4">
<div class="font-italic">Reason, why do you need blood?</div>
<div><textarea class="form-control" name="text"></textarea></div></div>
</div>
...
<?php if(isset($_POST['search'])){
  $bg=$_POST['blood'];
  $bc=$_POST['address'];
  $sql= "SELECT * FROM donor_details JOIN blood WHERE donor_details.donor_blood=blood.blood_group AND donor_blood='{$bg}' AND donor_address='{$bc}' ORDER BY rand() limit 5";
  $result=mysqli_query($conn,$sql) or die("query unsuccessful.");
